...
public final class ActivityChannelsBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityChannelsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityChannelsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_channels, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityChannelsBinding bind(@NonNull View rootView) {
